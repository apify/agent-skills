...
const USER_AGENT = 'apify-agent-skills/apify-linkedin-company-insights-1.0.0';
...
Options:
  --actor, -a       Actor ID (e.g., harvestapi/linkedin-company-employees) [required]
...
Examples:
  ...
  node --env-file=.env scripts/run_actor.js \\
    ...
    --input '{"companies": ["https://www.linkedin.com/company/google"], "profileScraperMode": "Short ($4 per 1k)"}'

  # Export all data to JSON
  node --env-file=.env scripts/run_actor.js \\
    --actor "harvestapi/linkedin-company-employees" \\
    --input '{"companies": ["https://www.linkedin.com/company/google"], "profileScraperMode": "Short ($4 per 1k)"}' \\
    --output employees.json --format json
`);
}
