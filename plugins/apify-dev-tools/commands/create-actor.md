...
2. Use `apify create <actor-name> -t <template>` to scaffold the project
...
- [${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/actor-json.md](${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/actor-json.md)
- [${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/input-schema.md](${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/input-schema.md)
- [${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/output-schema.md](${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/output-schema.md)
- [${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/dataset-schema.md](${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/dataset-schema.md)
- [${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/key-value-store-schema.md](${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/key-value-store-schema.md)
...
3. Implement standby mode readiness probe if `usesStandbyMode: true` (see [${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/standby-mode.md](${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/standby-mode.md))
4. Use proper logging (see [${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/logging.md](${CLAUDE_PLUGIN_ROOT}/skills/apify-actor-development/references/logging.md))
